...
final String editCategoryUrl = 'https://brainteaserdev.pythonanywhere.com/category/update/';

final String deleteCategoryUrl = 'https://brainteaserdev.pythonanywhere.com/category/delete/';
